      ...
      <v-row>
          ...
          <div>
            <v-navigation-drawer permanent>
              ...
              <v-list nav>
                <v-list-item
                  @click="
                    $router.push(`/${$i18n.locale}/addUser`).catch((err) => {})
                  "
                  link
                >
                ...
                <v-list-item
                  @click="
                    $router.push(`/${$i18n.locale}/allUsers`).catch((err) => {})
                  "
                  link
                >
        ...
        <v-col lg="9">
          ...
          <v-row justify="center">
            <v-col
              class="ms-3"
              v-for="(sortedSupplier, index) in suppliersSortedBySales.slice(
                0,
                10
              )"
              :key="index"
