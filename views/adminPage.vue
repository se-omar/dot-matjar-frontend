  ...
  <v-app v-if="currentUser.user_type">
    ...
    <v-row justify="center">
      <v-btn
        ...
        >{{ $t("adminPage.removeCategory") }}</v-btn
      >
      <!-- dialoge testing ============ -->
