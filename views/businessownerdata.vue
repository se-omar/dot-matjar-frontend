<template>
  <div id="app">
    <v-app>
      <v-parallax dark height="400" src="https://cdn.vuetifyjs.com/images/backgrounds/vbanner.jpg">
              ...
              <v-card class="px-4">
                <v-card-text>
                  <p>
                    ...
                    <a @click="$router.push('/completedata')">تعديل بياناتي من حسابي</a>
                  </p>
