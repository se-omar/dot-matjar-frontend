                    ...
                    <v-row>
                      ...
                      <v-col class="d-flex" cols="12" xsm="12" align-end>
                        <v-btn
                          ...
                          @click="validateLogin"
                        >
                          <span style="font-size: 18px;">تسجيل الدخول</span>
                        </v-btn>
                      </v-col>

                      <v-col align-center cols="3">
                        <v-btn @click="$router.push('/resetPassword')" text>
                          <span style="font-size: 20px; color: red">هل نسيت كلمة السر</span>
                        </v-btn>
                      </v-col>
                    </v-row>
                  </v-form>
                ...
                <v-card-text>
                  <v-form ref="registerForm" v-model="valid" lazy-validation>
                    <v-row>
                      ...
                      <v-col cols="12">
                        <v-text-field v-model="email" :rules="emailRules" label="الايميل" required></v-text-field>
                      </v-col>
                      <v-col cols="12">
                        <v-text-field
                          v-model="password"
