...
export default {
    ...
    mutations: {
        ...
        filterProducts(state, { products, pressed }) {
            ...
            if (pressed == "search") state.filteredProducts = products;
            else state.filteredProducts.push(...products);
        },
        ...
        getCategoriesTree(state, treeArray) {
            state.categoriesTreeArray = treeArray;
        },
    },
    ...
    actions: {
        ...
        async refreshCurrentUser(context) {
            ...
            await axios
                .post(
                    context.rootState.nodeHost + "/api/refreshCurrentUser",
                    bodyParameters,
                    config
                )
                .then((response) => {
            ...
            if (!productFilterFlag) {
                axios
                    .post(context.rootState.nodeHost + "/api/products", {
                        product_id:
                            context.state.filteredProducts.length > 0
                                ? context.state.filteredProducts[
                                    context.state.filteredProducts.length - 1
                                ].product_id
                                : null,
                    })
                    .then((response) => {
                ...
                axios
                    .post(context.rootState.nodeHost + "/api/loadMoreProductsWithFilter", {
                        product_id:
                            context.state.filteredProducts.length > 0
                                ? context.state.filteredProducts[
                                    context.state.filteredProducts.length - 1
        ...
        // getSuppliers(context, { supplierFilterFlag, supplierName, governorate, region }) {
        //   if (!supplierFilterFlag) {
        //     axios
        //       .post(context.rootState.nodeHost + "/api/getSuppliers", {
        //         user_id:
        //           context.state.suppliers.length > 0
        //             ? context.state.suppliers[context.state.suppliers.length - 1].user_id
        //             : null,
        //       })
        //       .then((response) => {
        //         //
        ...
        //   } else {
        //     axios
        //       .post(context.rootState.nodeHost + "/api/loadMoreSuppliersWithFilter", {
        //         user_id:
        //           context.state.suppliers.length > 0
        //             ? context.state.suppliers[context.state.suppliers.length - 1].user_id
        //             : null,
        ...
        // categoriesDB(context) {
        //   axios.put(context.rootState.nodeHost + "/api/selectCategory").then((res) => {
        //     //
        //     context.commit("categoriesDB", res.data.data);
        //   });
        // },
        ...
        filterSuppliers(context, { supplierName, governorate, region }) {
            //
            //

            axios
                .put(context.rootState.nodeHost + "/api/filterSuppliers", {
                    user_id:
                        context.state.suppliers.length > 0
                            ? context.state.suppliers[context.state.suppliers.length - 1].user_id
                            : null,
        ...
        getRegions(context, governorate) {
            //
            axios
                .put(context.rootState.nodeHost + "/api/getRegions", { governorate: governorate })
                .then((regions) => {
                    //
        ...
        addNewCategory(context, { categoryName, categoryArabicName }) {
            axios
                .post(context.rootState.nodeHost + "/api/addNewCategory", {
                    categoryName,
                    categoryArabicName,
                })
                .then((message) => {
        ...
        addCategoryItems(context, { categoryName, categoryItem, itemArabicName }) {
            axios
                .post(context.rootState.nodeHost + "/api/addCategoryItems", {
        ...
        removeCategoryAndItems(context, { categoryName, categoryItem }) {
            axios
                .put(context.rootState.nodeHost + "/api/removeCategoryAndItems", {
                    categoryName: categoryName,
                    categoryItem: categoryItem,
                })
                .then((message) => {
        ...
        getCategoryAndItemRequests(context) {
            axios
                .get(context.rootState.nodeHost + "/api/getCategoryAndItemRequests")
                .then((requests) => {
                    context.commit("getCategoryAndItemRequests", requests.data.data);
                });
        },
        categoryAndItemRequestStatus(
            context,
            {
                id,
                status,
            ...
            axios
                .put(context.rootState.nodeHost + "/api/categoryAndItemRequestStatus", {
                    id,
                    status,
                    newCategoryName,
                    newCategoryDescription,
        ...
        getSupplierCategoriesRequests(context) {
            //
            axios
                .put(context.rootState.nodeHost + "/api/getSupplierCategoriesRequests", {
                    user_id: context.state.currentUser.user_id,
                })
                .then((requests) => {
                    //
        ...
        updateSiteColors(
            ...
            axios
                .post(context.rootState.nodeHost + "/api/updateSiteColors", {
                    toolBarColor,
                    footerColor,
                    buttonsColor,
                    buttonsTextColor,
        ...
        async updateHomePage(
            context,
            { show_carousel, show_right_banner, carousel_width, carousel_height }
        ) {
            //

            await axios
                .post(context.rootState.nodeHost + "/api/updateHomePage", {
                    show_carousel,
                    show_right_banner,
                    carousel_width,
                    carousel_height,
        ...
        async uploadHomeCarouselImages(context, form) {
            await axios
                .post(context.rootState.nodeHost + "/api/uploadHomeCarouselImages", form, {
                    headers: {
        ...
        async uploadHomeBannerImages(context, form) {
            await axios
                .post(context.rootState.nodeHost + "/api/uploadHomeBannerImages", form, {
                    headers: {
                        "Content-Type": "multipart/form-data",
                    },
                })
        ...
        async removeHomeCarouselImage(context, { imgName }) {
            await axios
                .post(context.rootState.nodeHost + "/api/removeHomeCarouselImage", {
                    imgName,
                })
                .then((response) => {
                    //
        ...
        async removeHomeBannerImage(context, { imgName }) {
            await axios
                .post(context.rootState.nodeHost + "/api/removeHomeBannerImage", {
                    imgName,
                })
                .then((response) => {
                    //
        ...
        async getHomePageData(context) {
            await axios
                .put(context.rootState.nodeHost + "/api/getHomePageData")
                .then((info) => {
                    context.commit("getHomePageData", info.data.data);
                });
        },
        updateSupplierSiteColors(
            context,
            {
                toolBarColor,
                footerColor,
            ...
            axios
                .post(context.rootState.nodeHost + "/api/updateSupplierSiteColors", {
                    toolBarColor,
                    footerColor,
                    buttonsColor,
                    buttonsTextColor,
        ...
        async getAvailableCountries(context) {
            await axios
                .put(context.rootState.nodeHost + "/api/getAvailableCountries")
                .then((countries) => {
                    //
        ...
        async getWorldCountries(context) {
            axios.put(context.rootState.nodeHost + "/api/getWorldCountries").then((data) => {
                //
        ...
        addCountry(context, country) {
            axios
                .post(context.rootState.nodeHost + "/api/addCountry", { country })
                .then((message) => {
                    alert(message.data.message);
                });
        },
        getChoosenWorldCountries(context) {
            axios
                .put(context.rootState.nodeHost + "/api/getChoosenWorldCountries")
                .then((countries) => {
                    //
        ...
        removeCountry(context, country) {
            axios
                .put(context.rootState.nodeHost + "/api/removeCountry", { country: country })
                .then((res) => {
                    alert(res.data.message);
                });
        },
        getAllUsers(context) {
            var id =
                context.state.allUsers.length > 0
                    ? context.state.allUsers[context.state.allUsers.length - 1].user_id
                    : null;

            axios
                .put(context.rootState.nodeHost + "/api/getAllUsers", {
                    user_id:
                        context.state.allUsers.length > 0
                            ? context.state.allUsers[context.state.allUsers.length - 1].user_id
                            : null,
        ...
        getUser(context, user_id) {
            axios.put(context.rootState.nodeHost + "/api/getUser", { user_id }).then((user) => {
                //
        ...
        updateUserInfo(
            ...
            axios
                .put(context.rootState.nodeHost + "/api/updateUserInfoFromAdmin", {
                    national_number,
                    gender,
                    full_arabic_name,
                    full_english_name,
        ...
        deleteUser(context, user_id) {
            axios
                .put(context.rootState.nodeHost + "/api/deleteUser", { user_id: user_id })
                .then((message) => {
                    alert(message.data.message);
                });
        },
        loadmoreProducts(context, obj) {
            axios
                .put(context.rootState.nodeHost + "/api/loadmoreProducts", {
                    loadmoreType: context.state.loadmore.type,
                    loadmoreName:
                        context.state.loadmore && context.state.loadmore.category
                            ? context.state.loadmore.category.category_name
                            : "",
                    product_id: obj.id,
        ...
        getCategoriesTree(context) {
            axios
                .post(context.rootState.nodeHost + "/api/getCategoriesTree", {
