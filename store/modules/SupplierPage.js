...
export default {
  ...
  mutations: {
        ...
        if (siteLanguage == "en") {
          ...
          if (state.supplierCategories.length > 0) {
            for (var x = 0; x < state.supplierCategories.length; x++) {
              if (
                state.supplierCategories[x] ==
                data[i].product_category.category_arabic_name
              ) {
                check = true;
              }
            }
    ...
    getSupplierCategoriesTree(state, array) {
      state.supplierCategoriesTreeArray = array;
    },
  },

  actions: {
    async addSupplierReview(context, { supplier_id, user_id, rating, review }) {
      await axios
        .post(context.rootState.nodeHost + "/api/addSupplierReview", {
          supplier_id,
          user_id,
          rating,
          review,
    ...
    async getSupplier(context, id) {
      await axios
        .put(context.rootState.nodeHost + "/api/getSupplier", {
          user_id: id,
        })
        .then((supplier) => {
    ...
    async getSupplierPageData(context, id) {
      ...
      await axios
        .put(context.rootState.nodeHost + "/api/getSupplierPageData", {
          supplier_id: id,
        })
        .then((info) => {
    ...
    async getSupplierProducts(context, id) {
      await axios
        .put(context.rootState.nodeHost + "/api/supplierProducts", {
          user_id: id,
        })
        .then((response) => {
    ...
    async getSupplierReview(context, { supplier_id, user_id }) {
      await axios
    ...
    async getSupplierRatingsArray(context, supplier_id) {
      await axios
        .post(context.rootState.nodeHost + "/api/getSupplierRatingsArray", {
          supplier_id,
        })
        .then((response) => {
    ...
    updateSupplierPage(context, formdata) {
      axios
        .post(context.rootState.nodeHost + "/api/updateSupplierPage", formdata)
        .then((response) => {
    ...
    supplierPageColor(context, color) {
      axios
        .put(context.rootState.nodeHost + "/api/supplierPageColor", {
          page_color: color,
    ...
    calculateSupplierRating(context, supplier_id) {
      axios
        .post(context.rootState.nodeHost + "/api/calculateSupplierRating", {
          supplier_id,
        })
        .then((response) => {});
    },
    getPendingSuppliers(context) {
      axios
        .put(context.rootState.nodeHost + "/api/getPendingSuppliers")
        .then((suppliers) => {
    ...
    acceptSupplierRequest(context, user_id) {
      axios
        .put(context.rootState.nodeHost + "/api/acceptSupplierRequest", {
          user_id: user_id,
        })
        .then((message) => {
    ...
    async uploadCarouselImages(context, form) {
      await axios
        .post(context.rootState.nodeHost + "/api/uploadCarouselImages", form, {
          headers: {
    ...
    async uploadBannerImages(context, form) {
      await axios
        .post(context.rootState.nodeHost + "/api/uploadBannerImages", form, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
    ...
    async removeCarouselImage(context, { id, imgName }) {
      await axios
        .post(context.rootState.nodeHost + "/api/removeCarouselImage", {
          id,
          imgName,
        })
        .then((response) => {});
    ...
    async removeBannerImage(context, { id, imgName }) {
      await axios
        .post(context.rootState.nodeHost + "/api/removeBannerImage", {
          id,
          imgName,
        })
        .then((response) => {});
    ...
    addCategoryAndItemsToSupplier(context, { supplierItems, user_id, siteLanguage }) {
      axios
        .post(context.rootState.nodeHost + "/api/addCategoryAndItemsToSupplier", {
    ...
    //   await axios
    //     .put(context.rootState.nodeHost + "/api/getSupplierCategoriesAndItems", {
    //       user_id: user_id,
    //     })
    //     .then((data) => {
    ...
    rejectSupplierRequest(context, user_id) {
      axios
        .put(context.rootState.nodeHost + "/api/rejectSupplierRequest", user_id)
        .then((message) => {
          alert(message.data.message);
        });
    },

    supplierPageAddCategories(context, { supplierItems, user_id, siteLanguage }) {
      axios
        .post(context.rootState.nodeHost + "/api/supplierPageAddCategories", {
          supplierCategories: supplierItems,
          supplier_id: user_id,
    ...
    getSupplierCategoriesTree(context, supplier_id) {
      axios
        .post(context.rootState.nodeHost + "/api/getSupplierCategoriesTree", {
          supplier_id,
          language: localStorage.getItem("language"),
        })
        .then((response) => {
          console.log("suppliers categories tree", response);
